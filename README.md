...
A relational database is a database that stores it's data in tables while SQL is the language the allows you to query databases.

2. Why do tables need a `primary key`?

A primary key prevents duplicates and is a way to uniquely identify a row. It also makes it easier to join other tables.
...
An intermediary table that holds foreign keys that reference the primary key.
